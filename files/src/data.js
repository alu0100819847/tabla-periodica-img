let masa = ["1.00794", "6.941", "22.98976", "39.98976", "85.4678", "132.9054", "223",
            ...
            "26.98153", "", "", "47.867", "91.224", "178.49", "261",
            "174.9668", "", "", "50.9415", "92.90638", "180.9478", "262",
            "167.259", "", "", "51.9962", "95.96", "183.84", "266",
            "69.723", "", "", "54.93804", "98", "186.207", "264",
            "226", "", "", "55.845", "101.07", "190.23", "277",
            "126.9044", "", "", "58.93319", "102.9055", "192.217", "268",
            "74.92160", "", "", "58.6934", "106.42", "195.084", "271",
...
let ion = ["1312.0", "520.2", "495.8", "418.8.0", "403.0", "373.7", "380.0",
            ...
            "577.5", "", "", "658.8", "640.1", "658.5", "580.0",
            "523.5", "", "", "650.9", "652.1", "761.0", "",
            "589.3", "", "", "652.9", "684.3", "770.0", "",
            "578.8", "", "", "717.3", "702.0", "760.0", "",
            "509.3", "", "", "762.5", "710.2", "840.0", "",
            "1008.4", "", "", "760.4", "719.7", "880.0", "",
            "947.0", "", "", "737.1", "804.4", "870.0", "",
            "", "", "", "745.5", "731.0", "890.1", "",
            "", "", "", "906.4", "867.8", "1007.1", "",
...
let name = ["Hidrógeno", "Litio", "Sodio", "Potasio", "Rubidio", "Cesio", "Francio",
            ...
            "Aluminio", "", "", "Titanio", "Zirconio", "Hafnio", "Rutherfordio",
            "Lutecio", "", "", "Vanadio", "Niobio", "Tantalio", "Dubnio",
            "Erbio", "", "", "Cromo", "Molibdeno", "Wolframio", "Seaborgio",
            "Galio", "", "", "Manganeso", "Tecnecio", "Renio", "Bohrio",
            "Radio", "", "", "Hierro", "Rutenio", "Osmio", "Hassio",
            "Yodo", "", "", "Cobalto", "Rodio", "Iridio", "Meitnerio",
            "Arsénico", "", "", "Níquel", "Paladio", "Platino", "Darmstatio",
...
let type = ["svn-nb-nr-ef", "sc1-nb-nr", "sc1-nb-nr-ef", "sc1-nb-nr", "sc1-nb-nr", "sc1-nb-nr-ef", "sc1-nr",
            "sh", "sc2-nb-nr-ef", "sc2-nb-nr", "sc2-nb-nr", "sc2-nb-nr-ef", "sc2-nb-nr", "sc2-nr",
            "sh", "sh-yl", "sh-yl", "sm-nb-nr-ef", "sm-nb-nr", "sm-nb-nr-ef", "sm-nr",
            "sy-nm-nr-t7", "st7", "sh", "sm-nb-nr-ef", "sm-nb-nr", "sm-nb-nr", "sm-nr-ef",
            "sm-nr-t5", "st5", "sh", "sm-nb-nr", "sm-nb-nr-ef", "sm-nb-nr", "sm-nr",
            "sl-nr-t3", "st3", "sh", "sm-nb-nr-ef", "sm-nb-nr", "sm-nb-nr-ef", "sm-nr",
            "sy-nm-nr", "sh", "sh", "sm-nb-nr-ef", "sm-nb-nr", "sm-nb-nr", "sm-nr",
            "sc2-nr-t3", "st3", "sh", "sm-nb-nr-ef", "sm-nb-nr", "sm-nb-nr", "sm-nr-ef",
            "sp-nm-nr-t5", "st5", "sh", "sm-nb-nr-ef", "sm-nb-nr-ef", "sm-nb-nr-ef", "sm-nr",
            "sg-nm-t7", "st7", "sh", "sm-nb-nr", "sm-nb-nr-ef", "sm-nb-nr", "sm-nr-ef",
            "sh", "sh", "sh", "sm-nb-nr", "sm-nb-nr-ef", "sm-nb-nr-ef", "sm-nr",
            "sh", "sh", "sh", "sm-nb-nr-ef", "sm-nb-nr", "sm-nb-nr-ef", "sm-nr",
            "sh", "sg-nm-nb-nr", "sy-nm-nb-nr", "sy-nm-nb-nr", "sy-nm-nb-nr", "sy-nm-nb-nr", "sy-nm-nr",
            "sh", "svn-nb-nr-ef", "sg-nm-nb-nr", "sg-nm-nb-nr-ef", "sy-nm-nb-nr-ef", "sy-nm-nb-nr-ef", "sy-nm-nr",
            "sh", "svn-nb-nr-ef", "svn-nb-nr-ef", "sg-nm-nb-nr", "sg-nm-nb-nr", "sy-nm-nb-nr", "sy-nm-nr-ef",
            "sh", "svn-nb-nr-ef", "svn-nb-nr", "svn-nb-nr-ef", "sg-nm-nb-nr", "sg-nm-nb-nr-ef", "sy-nm-nr",
            "sh", "sp-nm-nb-nr", "sp-nm-nb-nr-ef", "sp-nm-nb-nr", "sp-nm-nb-nr-ef", "sp-nm-nb-nr", "sp-nm-nr-ef",
...
var cels = {'sh' : 'subbox-h',
            ...
            'sm-nr-ef': 'subbox-middle nright elemfoto',
            'sg-nm': 'subbox-g-nometal',
            'sg-nm-nb-nr': 'subbox-g-nometal nbot nright',
            'sg-nm-nb-nr-ef': 'subbox-g-nometal nbot nright elemfoto',
            'sy-nm-nb-nr': 'subbox-y-nometal nbot nright',
            'sy-nm-nr': 'subbox-y-nometal nright',
            'sy-nm-nr-ef': 'subbox-y-nometal nright elemfoto',
            ...
            'sp-nm-nr-ef': 'subbox-p-nometal nright elemfoto',
            'sp-nm-nb-nr-ef': 'subbox-p-nometal nbot nright elemfoto',
            'sgn': 'subbox-gn',
            'sgn-nb': 'subbox-gn nbot',
            'sgn-nb-ef': 'subbox-gn nbot elemfoto',
            'sl-nr': 'subbox-l nright',
            'st3':'subbox-t-3',
            'st5':'subbox-t-5',
            'st7':'subbox-t-7',
            'sy-nm-nr-t7':'subbox-y-nometal nright title-7',
            'sm-nr-t5':'subbox-middle nright title-5',
            'sl-nr-t3':'subbox-l nright title-3',
            'sc2-nr-t3':'subbox-c2 nright title-3',
            'sp-nm-nr-t5': 'subbox-p-nometal nright title-5',
            'sg-nm-t7': 'subbox-g-nometal title-7'
          }
